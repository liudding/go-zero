...
func init() {
	...
	datasourceCmdFlags.StringVar(&command.VarStringRemovePrefix, "remove-prefix")
	...
	pgDatasourceCmdFlags.StringVar(&command.VarStringRemovePrefix, "remove-prefix")
	...
	mongoCmdFlags.StringVar(&command.VarStringRemovePrefix, "remove-prefix")
